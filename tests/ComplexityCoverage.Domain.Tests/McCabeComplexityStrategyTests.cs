...
public void Test() {
    ...
    var f = 4;
            ...
            Check.That(weights[7].Weight).IsStrictlyGreaterThan(2);
        }
...
public void Test() {
    ...
    while (true) {
        ...
        break;
            ...
            Check.That(weights[6].Weight).IsStrictlyGreaterThan(1);
        }
...
public void Test() {
    ...
    var c = 3;
            ...
            Check.That(weights.Max(w => w.Weight)).IsStrictlyGreaterThan(0);
        }
    }
}
